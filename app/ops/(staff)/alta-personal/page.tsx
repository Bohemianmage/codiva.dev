...
import { createPersonnelOffer } from '@/lib/ops/actions';
import {
  OFFER_STATUS_LABELS,
  OPS_ROLE_LABELS,
...
export default async function AltaPersonalPage() {
  ...
  return (
    <div>
      <OpsPageHeader
        ...
        description="Cartas oferta y altas del equipo de operaciones de Codiva. Solo administradores."
      />

      <div className="max-w-3xl space-y-8">
        <p className="text-sm">
          <Link href="/team" className="text-codiva-primary hover:underline">
            Ir a Equipo (acceso Ops) →
          </Link>
        </p>
        ...
        <section className="space-y-3">
          <h2 className="font-semibold">Altas y ofertas</h2>
          {!(offers ?? []).length ? (
