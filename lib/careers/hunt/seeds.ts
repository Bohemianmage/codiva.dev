...
export const HUNT_SEEDS: HuntSeed[] = [
  ...
  },
  {
    ...
    surface: 'career',
    paths: ['/empleos', '/'],
    anchors: ['lang=en', 'lang="en"', "lang='en'", 'open positions'],
    keywords: ['idioma', 'ingles', 'english', 'i18n', 'html', 'lang'],
    craft: 'ux-ui',
    difficulty: 'easy',
  },
  {
  ...
  },
  {
    ...
    keywords: ['aria', 'label', 'boton', 'icono', 'iconos', 'footer', 'pie', 'ayuda'],
    craft: 'ux-ui',
    difficulty: 'medium',
  },
  {
  ...
  },
  {
    ...
    surface: 'marketing',
    paths: ['*'],
    anchors: ['teclado', 'keyboard', 'enter', 'con el teclado', 'keypress'],
