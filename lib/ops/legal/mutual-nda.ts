...
<body>
  <main>
    ...
    <p>${objectBody}</p>
    <p>
      El presente Acuerdo tiene por objeto exclusivamente regular el intercambio de Información
      Confidencial entre las Partes y no constituye oferta, promesa, compromiso u obligación de
      celebrar contrato alguno, desarrollar el Proyecto o mantener negociaciones entre ellas.
    </p>
    ...
    <p>
      También se considerará Información Confidencial cualquier análisis, compilación, resumen,
      reporte, desarrollo, prueba, prototipo o documento elaborado por la Parte Receptora que
      incorpore, reproduzca, derive o revele la Información Confidencial proporcionada por la
      Parte Reveladora.
    </p>
    ...
    <ul>
      ...
      <li>
        No copiar, reproducir, modificar, descompilar, realizar ingeniería inversa o utilizar la
        Información Confidencial para fines distintos al Proyecto, salvo lo estrictamente necesario
        para evaluar o ejecutar el Proyecto o con autorización previa y por escrito de la Parte
        Reveladora.
      </li>
      <li>
        No utilizar la Información Confidencial para entrenar modelos de inteligencia artificial,
        sistemas automatizados o herramientas de aprendizaje automático sin autorización previa y
        por escrito de la Parte Reveladora.
      </li>
      <li>
        Notificar sin demora a la Parte Reveladora cualquier acceso, uso o divulgación no
        autorizada de la Información Confidencial de la que tenga conocimiento.
      </li>
      <li>
        Adoptar las medidas administrativas, físicas y técnicas razonablemente necesarias para
    ...
    <p>
      Nada en este NDA transfiere titularidad de Propiedad Intelectual. Los entregables de
      desarrollo se regirán por el contrato de servicios / cotización aceptada.
    </p>
    <p>
      Ninguna disposición del presente Acuerdo se interpretará como una cesión, licencia o
      autorización de uso respecto de marcas, derechos de autor, patentes, secretos industriales,
      software, desarrollos, invenciones o cualquier otro derecho de propiedad intelectual de
    ...
    <h2>9. Incumplimiento</h2>
    <p>
      Las Partes reconocen que la divulgación no autorizada de la Información Confidencial puede
      ocasionar daños de difícil reparación. En consecuencia, la Parte afectada podrá solicitar las
      medidas cautelares, precautorias o judiciales que resulten procedentes conforme a la
      legislación aplicable, sin perjuicio de ejercer las demás acciones legales que correspondan.
    </p>

    <h2>10. Acuerdo íntegro y modificaciones</h2>
    <p>
      El presente Acuerdo constituye el acuerdo total entre las Partes respecto de su objeto y
      sustituye cualquier entendimiento previo relacionado con la confidencialidad de la
      información. Cualquier modificación deberá constar por escrito y estar firmada por ambas
      Partes.
    </p>
